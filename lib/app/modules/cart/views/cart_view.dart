...
class _CartViewState extends State<CartView> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CartController>(
      builder:
          (cartController) => (Scaffold(
            backgroundColor: Colors.white,
            appBar:
                widget.fromNav!
                    ? AppBar(
                      title: Text("MY_CART".tr, style: fontBoldWithColor),
                      actions: [
                        if (splashController.configData.orderSetupDelivery ==
                                5 &&
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              child: ToggleSwitch(
                                ...
                                radiusStyle: true,
                                onToggle: (index) {
                                  cartController.setDeliveryOrTakey(index ?? 0);
                                },
                              ),
                            ),
                          ),
                        if (splashController.configData.orderSetupDelivery ==
                                5 &&
                            splashController.configData.orderSetupTakeaway ==
                                10)
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: SizedBox(
