...
class _ItemViewState extends State<ItemView> {
  ...
  void initState() {
    ...
    setState(() {
      totalPrice =
          homeController.itemDetailsData.value.offer!.isNotEmpty
                                                                  ...
                                                                  children: [
                                                                    SizedBox(
                                                                      ...
                                                                      height:
                                                                          20.h,
                                                                      child:
                                                                          homeController.variationList[y].id ==
                                                                                  homeController.itemDetailsData.value.variations[homeController.itemDetailsData.value.itemAttributes![y].id.toString()][x]['id']
                                                                              ? SvgPicture.asset(
...
Widget multiVariation(context, ItemData itemdetails) {
  ...
  return GetBuilder<CartController>(
    builder:
        (cartController) => ListView.builder(
          physics: const NeverScrollableScrollPhysics(),
          shrinkWrap: true,
          scrollDirection: Axis.vertical,
          itemCount: 1,
